...
config :ca_api, CaApiWeb.Endpoint,
  url: [host: "localhost"],
  adapter: Bandit.PhoenixAdapter,
  render_errors: [
    formats: [html: CaApiWeb.ErrorHTML, json: CaApiWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: CaApi.PubSub,
  live_view: [signing_salt: "W267xfvL"]
...
config :ca_api, CaApi.Mailer, adapter: Swoosh.Adapters.Local
